<?php
	$titlesite = 'Samuel UC Diseños, uso de illustrator para trabajos de imágenes, logotipos y gráficos';
	$metadescription = '<meta name="description" content="Trabajos ejemplo de elementos y contenidos gráficos, ejemplos de uso de herramientas PhotoShop e Illustrator, diseño de logotipos e imágenes vectorizadas">';
	$metakey= '<meta name="keywords" content="Diseño,graficos,imágenes,gráficas,creaciones,Samuel,UC">';
	include 'header.php';
?>
	<div class="row">
	<br>
